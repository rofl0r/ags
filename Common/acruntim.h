...
struct ScriptDrawingSurface : AGSCCDynamicObject {
  ...
  void StartDrawing();
  void MultiplyThickness(long *adjustValue);
  void UnMultiplyThickness(long *adjustValue);
  void MultiplyCoordinates(long *xcoord, long *ycoord);
...
extern long  IsChannelPlaying(long chan) ;
extern long stop_and_destroy_channel (long chid) ;
...
extern long add_inventory(long inum);
extern long lose_inventory(long inum);
...
extern long MoveToWalkableArea(long charid);
extern long Display(char*, ...);
...
extern long FaceCharacter(long cha,long toface);
extern long NewRoom(long);
...
extern long update_invorder(void);
extern long  GetRegionAt (long xxx, long yyy);
extern long SetNextCursor(void);
extern long SetActiveInventory(long iit);
extern void _DisplaySpeechCore(int chid, char *displbuf);
extern void _DisplayThoughtCore(int chid, const char *displbuf);
extern long  DisplaySpeechBackground(long charid,char*speel);
extern long DisplaySpeechAt (long xx, long yy, long wii, long aschar, char*spch);
extern char *get_translation(const char*);
extern int  can_see_from(int,int,int,int);
extern long  GetCursorMode();
extern long disable_cursor_mode(long);
extern long enable_cursor_mode(long);
extern long set_cursor_mode(long);
...
extern long PlayAmbientSound (long channel, long sndnum, long vol, long x, long y);
extern void* ccGetSymbolAddress (char*);
extern long GetScalingAt (long x, long y) ;
...
extern long free_dynamic_sprite (long gotSlot);
...
// Character methods
extern long Character_AddInventory(CharacterInfo *chaa, ScriptInvItem *, long addIndex);
extern long Character_AddWaypoint(CharacterInfo *chaa, long x, long y);
extern long Character_Animate(CharacterInfo *chaa, long loop, long delay, long repeat, long direction, long blocking);
extern long Character_ChangeRoom(CharacterInfo *chaa, long room, long x, long y);
extern long Character_ChangeRoomAutoPosition(CharacterInfo *chaa, long room, long newPos);
extern long Character_ChangeView(CharacterInfo *chap, long vii);
extern long Character_FaceCharacter(CharacterInfo *char1, CharacterInfo *otherChar, long blockingStyle);
extern long Character_FaceLocation(CharacterInfo *char1, long xx, long yy, long blockingStyle);
extern long Character_FaceObject(CharacterInfo *char1, ScriptObject* obj, long blockingStyle);
extern long Character_FollowCharacter(CharacterInfo *chaa, CharacterInfo *tofollow, long distaway, long eagerness);
extern long  Character_GetProperty(CharacterInfo *chaa, const char *property);
extern long Character_GetPropertyText(CharacterInfo *chaa, const char *property, char *bufer);
extern long  Character_HasInventory(CharacterInfo *chaa, ScriptInvItem *);
extern long  Character_IsCollidingWithChar(CharacterInfo *char1, CharacterInfo *cchar2) ;
extern long  Character_IsCollidingWithObject(CharacterInfo *chin, ScriptObject *objid);
extern long Character_LockView(CharacterInfo *chap, long vii);
extern long Character_LockViewAligned(CharacterInfo *chap, long vii, long loop, long align);
extern long Character_LockViewFrame(CharacterInfo *chaa, long view, long loop, long frame);
extern long Character_LockViewOffset(CharacterInfo *chap, long vii, long xoffs, long yoffs);
extern long Character_LoseInventory(CharacterInfo *chap, ScriptInvItem *);
extern long Character_Move(CharacterInfo *chaa, long x, long y, long direct, long blocking);
extern long Character_PlaceOnWalkableArea(CharacterInfo *chap);
extern long Character_RemoveTint(CharacterInfo *chaa);
extern long Character_RunInteraction(CharacterInfo *chaa, long mood);
extern long Character_Say(CharacterInfo *chaa, const char *texx, ...);
extern long Character_SayAt(CharacterInfo *chaa, long x, long y, long width, const char *texx);
extern ScriptOverlay* Character_SayBackground(CharacterInfo *chaa, const char *texx);
extern long Character_SetAsPlayer(CharacterInfo *chaa);
extern long Character_SetIdleView(CharacterInfo *chaa, long iview, long itime);
extern long Character_SetOption(CharacterInfo *chaa, long option, long yesorno);
extern long Character_SetSpeed(CharacterInfo *chaa, long xspeed, long yspeed);
extern long Character_StopMoving(CharacterInfo *charp);
extern long Character_Think(CharacterInfo *chaa, const char *texx, ...);
extern long Character_Tint(CharacterInfo *chaa, long red, long green, long blue, long opacity, long luminance);
extern long Character_UnlockView(CharacterInfo *chaa);
extern long Character_Walk(CharacterInfo *chaa, long x, long y, long direct, long blocking);
extern long Character_WalkStraight(CharacterInfo *chaa, long x, long y, long blocking);

// Character properties
extern ScriptInvItem* Character_GetActiveInventory(CharacterInfo *chaa);
extern long Character_SetActiveInventory(CharacterInfo *chaa, ScriptInvItem *iit);
extern long  Character_GetAnimating(CharacterInfo *chaa);
extern long  Character_GetAnimationSpeed(CharacterInfo *chaa) ;
extern long Character_SetAnimationSpeed(CharacterInfo *chaa, long newval);
extern long  Character_GetBaseline(CharacterInfo *chaa);
extern long Character_SetBaseline(CharacterInfo *chaa, long basel);
extern long  Character_GetBlinkInterval(CharacterInfo *chaa);
extern long Character_SetBlinkInterval(CharacterInfo *chaa, long interval);
extern long  Character_GetBlinkView(CharacterInfo *chaa);
extern long Character_SetBlinkView(CharacterInfo *chaa, long vii);
extern long  Character_GetBlinkWhileThinking(CharacterInfo *chaa);
extern long Character_SetBlinkWhileThinking(CharacterInfo *chaa, long yesOrNo);
extern long  Character_GetBlockingHeight(CharacterInfo *chaa);
extern long Character_SetBlockingHeight(CharacterInfo *chaa, long hit);
extern long  Character_GetBlockingWidth(CharacterInfo *chaa);
extern long Character_SetBlockingWidth(CharacterInfo *chaa, long wid);
extern long  Character_GetClickable(CharacterInfo *chaa);
extern long Character_SetClickable(CharacterInfo *chaa, long clik);
extern long  Character_GetDiagonalWalking(CharacterInfo *chaa);
extern long Character_SetDiagonalWalking(CharacterInfo *chaa, long yesorno);
extern long  Character_GetFrame(CharacterInfo *chaa);
extern long Character_SetFrame(CharacterInfo *chaa, long newval);
extern long  Character_GetHasExplicitTint(CharacterInfo *chaa);
extern long  Character_GetID(CharacterInfo *chaa);
extern long  Character_GetIdleView(CharacterInfo *chaa);
extern long  Character_GetIInventoryQuantity(CharacterInfo *chaa, long index);
extern long Character_SetIInventoryQuantity(CharacterInfo *chaa, long index, long quantity);
extern long  Character_GetIgnoreLighting(CharacterInfo *chaa);
extern long Character_SetIgnoreLighting(CharacterInfo *chaa, long yesorno);
extern long  Character_GetIgnoreScaling(CharacterInfo *chaa);
extern long Character_SetIgnoreScaling(CharacterInfo *chaa, long yesorno);
extern long  Character_GetIgnoreWalkbehinds(CharacterInfo *chaa);
extern long Character_SetIgnoreWalkbehinds(CharacterInfo *chaa, long yesorno);
extern long  Character_GetLoop(CharacterInfo *chaa);
extern long Character_SetLoop(CharacterInfo *chaa, long newval);
extern long Character_SetManualScaling(CharacterInfo *chaa, long yesorno);
extern long  Character_GetMovementLinkedToAnimation(CharacterInfo *chaa);
extern long Character_SetMovementLinkedToAnimation(CharacterInfo *chaa, long yesorno);
extern long  Character_GetMoving(CharacterInfo *chaa);
extern const char* Character_GetName(CharacterInfo *chaa);
extern long Character_SetName(CharacterInfo *chaa, const char *newName);
extern long  Character_GetNormalView(CharacterInfo *chaa);
extern long  Character_GetPreviousRoom(CharacterInfo *chaa);
extern long  Character_GetRoom(CharacterInfo *chaa);
extern long  Character_GetScaleMoveSpeed(CharacterInfo *chaa);
extern long Character_SetScaleMoveSpeed(CharacterInfo *chaa, long yesorno);
extern long  Character_GetScaleVolume(CharacterInfo *chaa);
extern long Character_SetScaleVolume(CharacterInfo *chaa, long yesorno);
extern long  Character_GetScaling(CharacterInfo *chaa);
extern long Character_SetScaling(CharacterInfo *chaa, long zoomlevel);
extern long  Character_GetSolid(CharacterInfo *chaa);
extern long Character_SetSolid(CharacterInfo *chaa, long yesorno);
extern long  Character_GetSpeaking(CharacterInfo *chaa);
extern long  GetCharacterSpeechAnimationDelay(CharacterInfo *cha);
extern long Character_SetSpeechAnimationDelay(CharacterInfo *chaa, long newDelay);
extern long  Character_GetSpeechColor(CharacterInfo *chaa);
extern long Character_SetSpeechColor(CharacterInfo *chaa, long ncol);
extern long  Character_GetSpeechView(CharacterInfo *chaa);
extern long Character_SetSpeechView(CharacterInfo *chaa, long vii);
extern long  Character_GetThinkView(CharacterInfo *chaa);
extern long Character_SetThinkView(CharacterInfo *chaa, long vii);
extern long  Character_GetTransparency(CharacterInfo *chaa);
extern long Character_SetTransparency(CharacterInfo *chaa, long trans);
extern long  Character_GetTurnBeforeWalking(CharacterInfo *chaa);
extern long Character_SetTurnBeforeWalking(CharacterInfo *chaa, long yesorno);
extern long  Character_GetView(CharacterInfo *chaa);
extern long  Character_GetWalkSpeedX(CharacterInfo *chaa);
extern long  Character_GetWalkSpeedY(CharacterInfo *chaa);
extern long  Character_GetX(CharacterInfo *chaa);
extern long Character_SetX(CharacterInfo *chaa, long newval);
extern long  Character_GetY(CharacterInfo *chaa);
extern long Character_SetY(CharacterInfo *chaa, long newval);
extern long  Character_GetZ(CharacterInfo *chaa);
extern long Character_SetZ(CharacterInfo *chaa, long newval);
...
extern AGS_INLINE void multiply_up_coordinates(long *x, long *y);
